...
public class Person implements Comparable<Person> {
     ...
     */
    public static boolean validate_passportID(String S){
        if (S.isEmpty()){
            return false;
        }
        else{
     ...
     */
    public static boolean validate_height(String S){
        try
        {
     ...
     */
    public static boolean validate_weight(String S){
        try
        {
     ...
     */
    public static boolean validate_ID(String S){
        try
        {
            int num = Integer.parseInt(S);
            if (num>0)
